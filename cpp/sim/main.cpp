...
// compile glad.c, header include paths, library path and name, glad gl 4.1 all graphics cards

// clang++ main.cpp camera.cpp ./glad/src/glad.c -std=c++20 -o app -I/Library/Frameworks/SDL2.framework/Headers/ -I./glad/include -I./../common -F/Library/Frameworks -rpath /Library/Frameworks -framework SDL2
// clang++ main.cpp ./glad/src/glad.c -std=c++20 -o app -I/Library/Frameworks/SDL2.framework/Headers/ -I./libs -I./glad/include -I./../common -F/Library/Frameworks -rpath /Library/Frameworks -framework SDL2